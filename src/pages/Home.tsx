  ...
  return (
    <div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        {/* Glow orbs */}
        <div className="pointer-events-none absolute -top-48 -left-48 w-[600px] h-[600px] rounded-full bg-cyan-500/10 blur-[120px]" />
        <div className="pointer-events-none absolute -bottom-48 -right-24 w-[500px] h-[500px] rounded-full bg-violet-600/10 blur-[100px]" />
          ...
          {projects.map((project, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  {/* Category color bar */}
                  <div className={`h-1 sm:h-auto sm:w-1 flex-shrink-0 ${cat.bar} opacity-80`} />

                  <div className="flex-1 p-6 flex flex-col sm:flex-row gap-6">
                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-brand-subtle
      ...
      <section className="section border-t border-brand-border">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }} transition={{ duration: 0.55 }}
            className="glass rounded-xl p-6 border-l-4 border-amber-400/50"
          >
      ...
      <section className="section">
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-3 relative">Let's build something together</h2>
